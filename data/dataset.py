...
class COVIDxFolder(Dataset):
    """A callable class function to prepare and iterate though the COVIDx dataset."""
    def __init__(self, img_dir, labels_file, transforms):
        """
            Initializes the class and prepares data.

            :param img_dir: Image directory
            :param labels_file: labels file path
            :param transforms: Transforms function for data pre-processing
            :return:
            """
